...
async function syncGMC() {
  if (!MERCHANT_ID || !process.env.GOOGLE_PRIVATE_KEY) {
    console.error("Missing GMC environment variables. Ensure GOOGLE_CLIENT_EMAIL, GOOGLE_PRIVATE_KEY, and MERCHANT_ID are set.");
    process.exit(1);
  }
